...
import { Check, X, Crown, Zap, Star, Gem, Globe } from "lucide-react";
...
const licenseOptions: LicenseOption[] = [
  {
    ...
    features: [
      "1 000 игровых монет / кредитов",
      "Моментальная выдача кода",
      "Поддержка популярных игр",
      "Безопасная оплата",
      "Чек на e-mail",
    ],
    bulkDeal: "КУПИ 2 — ПОЛУЧИ БОНУС +10%!",
  },
  {
    ...
    features: [
      "3 000 игровых монет / кредитов",
      "Моментальная выдача кода",
      "Поддержка всех игр каталога",
      "Безопасная оплата",
      "Чек и инструкция на e-mail",
  ...
  },
  {
    ...
    notIncluded: ["Без реферального бонуса"],
  },
  {
    name: "VIP пакет",
    price: "1 499 руб",
    ...
    features: [
      "15 000 игровых монет / кредитов",
      "Моментальная выдача кода",
      "Весь каталог игр и платформ",
      "Безопасная оплата",
  ...
  return (
    <section ref={ref} id="licenses" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold mb-6 text-white">Выбери свой пакет</h2>
          <p className="text-xl text-zinc-400 max-w-2xl mx-auto">
            Пополни баланс любимой игры или получи игровой код — выбирай нужный пакет и получай
